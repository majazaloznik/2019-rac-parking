...
`r paste(FunDec(wal.summary[5, 6], dp.text), "%")` of net transport epxenditure. Since `r FunFisc(4)` income has `r ifelse(wal.summary[1,6] > wal.summary[1,2], "risen", "fallen")` by 
