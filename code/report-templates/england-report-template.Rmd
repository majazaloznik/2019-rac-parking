...
Table \@ref(tab:expendtab) ranks the top 50 English councils in terms of expenditure on parking.
...
The largest increase in expenditure occured in `r eng.expend.change.top3[1,2]` where it increased by `r FunDec(eng.expend.change.top3$change[1], dp.text)` %
...
The table also shows the proportion of income taken up by costs in `r FunFisc()`. 
...
eng.expend.formatted %>% 
  ...
  kable( "latex", 
         ...
         longtable = TRUE,
         align = c("r"),
         caption = "Parking expenditure for England (£,000)",
         format.args = list(big.mark = ","),
         linesep = "",
         col.names = c("\\multirow{1}{*}[0pt]{Local Authority}", yearz, 
                       paste0("Change ", FunFisc(), 
...
Table \@ref(tab:expendprop) shows the proportion of income taken up by expenditure over the previous four years. Across England it was `r FunDec(eng.expend.of.income.tot, dp.text)` % compared to `r FunDec(eng.expend.of.income.tot.prev, dp.text)` % in the previous year.
