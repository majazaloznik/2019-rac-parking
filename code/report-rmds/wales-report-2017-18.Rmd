...
`r paste(FunDec(wal.summary[5, 6], 1), "%")` of transport costs. 

Parking makes a 
`r ifelse(wal.summary[5, 6] < eng.trans - 0.05 , "smaller", ifelse(wal.summary[5, 6] > eng.trans + 0.05,  "larger","similar"))` contribution to overall transport expenditure in Wales compared with England where it is around `r FunDec(eng.trans, 1)` % of total transport. 
