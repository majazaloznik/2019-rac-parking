...
```{r mapincome, fig.cap = "Map of change in parking income since previous fiscal year", fig.height = 3, fig.pos = "H"}
# map income change
...
```{r mapincome4, fig.cap = "Map of average annual change in parking income over the past four years", fig.height = 3}
# map income change
...
```{r mapexpend, fig.cap = "Map of change in parking expenditure since previous fiscal year", fig.height = 3.5}
...
```{r mapexpend4, fig.cap = "Map of average annual change in parking expenditure over the past four years", fig.height = 3.5}
# map change in expenditure
