...
\color{red}PHIL: \color{black}The accuracy of this analysis depends on the accuracy with which local authorities complete the annual financial returns they make to central government and upon which this assessment is based.

\color{red}IVO: \color{black}These headings do not always agree with accounts published by local authorities because of their different treatment of overheads and allocation of surpluses to other transport projects.
\newpage
...
\color{red}PHIL: \color{black}The parking surplus in London was £`r FunDec(lnd.surplus, dp.text)` million, `r FunDec(lnd.prop.surplus, dp.text)`% of the total for England. Incoming commuters and visitors will contribute to parking fees and penalties which are much higher than in the rest of England.

\color{red}IVO: \color{black}[deleted whole para]
