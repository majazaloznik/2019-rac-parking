...
The file currenlty has 4138 rows as shown in Table \@ref(tab:rows). Note that the most recent year for England is actually just the budgeted surplus data, which is why there is no row for the national transport totals. 
