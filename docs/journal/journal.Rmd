...
Processwise, I imagined you guys for each new round of data:
1. downloading the data or fiding the correct links
2. entering relevant data (file locations, urls, or manual unput in some cases) into an R script template. 
3. Running said script, which updates the master data file.
4. Opening an .Rmd template
