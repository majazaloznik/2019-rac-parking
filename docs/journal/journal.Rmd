...
* *change outturn name of file from RS to RO2 or whatever*
...
* *if the budget data for next year is not reported for all LAs, like for 2019, there should probably be a note made of this?* 
...
* Damn, i fixed the NA budget for 2018, but it's wrong again!? where did i loose that? *fix it again*
...
* also, the comparison table is missing in the wales report,  *should be put back in. *


* *add bac scotland 2017-2018 data into my repo!*
