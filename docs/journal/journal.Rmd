...
* plot. OK
* issues: floats of tables and figures, little control..
...
* * still need to replicate for incomes and expenditures. in wales*
...
* OK, import calculates surplus for Scotland now. OK *could remove the superflous claculations of it later - although it makes no difference*
