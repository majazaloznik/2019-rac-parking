...
* *there's sth wrong with the tables in tech documentation..*
...
* up/down. increased/decreased.. if negative should be absolute. i guess i didn't make sure all of them were. so i'll have to *go through the whole thing and double check*. Done for England. Wales done

* fixed the expenditure code that switches between thousands and millions if the numbers are too low. *check other reports for same code*
