...
* move WPL manual entry to 00-manual-data-input.R 
* Also add year to the manual WPL entry instead of wpl.year, because it gets added using bind.row anyway. Oh, actually it should get added using full_join, so they are not separate rows. 
