...
* up/down. increased/decreased.. if negative should be absolute. i guess i didn't make sure all of them were. so i'll have to *go through the whole thing and double check*. Done for England.
